              ...
              <div className="finace-acc">
                ...
                <hr className="mob-disp" />
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                      Dynamics 365 Supply Chain is highly configured with AI and <a href="/products/microsoft-azure/">IoT capabilities</a> to streamline manufacturing & distribution processes while enabling remote process handling and reducing error potentials.
                      </div>
                    </div>
                  </div>
                  <hr />
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      chain efficiency, <a href="/contact-us/">Dynamics Square</a>{" "} can help.
                      </p>                  
                  </div>
                  </div>
                </div>
